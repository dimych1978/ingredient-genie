// hooks/useTelemetronAuth.ts - ПОЛНАЯ заглушка
"use client";

export const useTelemetronAuth = () => {
  return {
    token: null,
    loading: false,
    error: null,
    getToken: async () => {
      console.log('[STUB] getToken called - returning null');
      return null;
    },
    getTokenInfo: () => {
      console.log('[STUB] getTokenInfo called');
      return { token: null, isValid: false };
    }
  };
};// // hooks/useTelemetronAuth.ts
// "use client";
